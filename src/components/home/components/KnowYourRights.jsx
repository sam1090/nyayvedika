...
const KnowYourRights = () => {
  return (
    <section id="kyr" className="mt-6 px-6 pb-16 w-full">
      <p className="font-poppins mb-3 text-[#808080]">Know Your Rights...</p>
      <div className="flex flex-wrap w-full gap-3">
        <div className="w-full rounded-lg bg-white flex justify-between p-2 px-3 font-medium font-poppins items-center">
          <p>Labour Laws</p>
